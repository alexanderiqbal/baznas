            ...
            <div class="col-md-15 grid-margin">
                ...
                <form method="POST" action="proses/input/simpandonasi.php" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="nama" readonly type="text" class="form-control" value="<?php echo $_SESSION['nama']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="jmlh" readonly type="number" class="form-control" id="jmlh" value="<?php echo $besaran; ?>">
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <button type="submit" name="simpan" class="btn btn-primary">Berdonasi</button>
                    </div>
                </form>
