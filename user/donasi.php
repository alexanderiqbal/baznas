    ...
    <section>
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h3>List Donasi Baznas Kota Padang</span></h3>

            </div>
            <p type="button" class="btn btn-info btn-fw"><a href="inputdonasi.php"><span>Salurkan Donasi</span></a></p>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    include "../koneksi.php";
                                    $no = 1;
                                    $datakat = mysqli_query($koneksi, "SELECT * FROM donasi
