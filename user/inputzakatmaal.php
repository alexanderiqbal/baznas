                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="zakatpenghasilan">
                                <form method="POST" action="inputbukti.php">
                                    ...
                                    ?>
                                    <input name="tgl" hidden type="text" class="form-control" id="tgl" value="<?php echo tgl_indo(date('Y-m-d')); ?>">
                                    <input name="id1" hidden type="text" class="form-control" id="id1" value="<?php echo $_SESSION['id_user']; ?>">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="simpanfitrah" class="btn btn-primary">Berzakat</button>
                                    </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="zakatmaal">
                                <form method="POST" action="inputbukti.php">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="simpanmaal" class="btn btn-primary">Bayar</button>
                                    </div>
