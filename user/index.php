    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h3>History Pembayaran Yang Sudah Disalurkan</span></h3>
        </div>
              ...
              <div class="table-responsive">
                <table class="table table-borderless">
                  ...
                  <tbody>
                    ...
                    $datakat = mysqli_query($koneksi, "SELECT * FROM pembayaran INNER JOIN penerima ON pembayaran.id_byr = penerima.id_pembayaran where pembayaran.id_bayar = '$iduser' ");
