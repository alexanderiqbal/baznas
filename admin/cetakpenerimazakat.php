...
<body>
    <header id="header">
        ...
        <table class="table table-borderless">
            ...
            include "../koneksi.php";
            $data = mysqli_query($koneksi, "SELECT * FROM pembayaran INNER JOIN penerima ON pembayaran.id_byr=penerima.id_pembayaran WHERE pembayaran.jenis NOT LIKE 'Donasi'");
            $no = 1;
