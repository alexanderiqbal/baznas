        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="listpenerimazakat.php">Mustahiq</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="modal-body">
                                    <form class="row g-3" id="discussionForm" method="post" action="proses/input/simpanpenerima.php" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            $result = mysqli_query($koneksi, "SELECT * FROM pembayaran WHERE NOT EXISTS (SELECT * FROM penerima WHERE pembayaran.id_byr = penerima.id_pembayaran )AND pembayaran.jenis NOT LIKE 'donasi'");
                    ...
                    <h5 class="card-title">List Mustahiq</h5>
                    <p type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#maiModal">Tambah Data</p>

                    <a type="button" href="cetakpenerimazakat.php" class="btn btn-warning" style="float: right;">Print</a>
                    ...
                    <table class="table table-borderless text-center">
                        ...
                        <tbody>
                            ...
                            include "../koneksi.php";
                            $no = 1;
                            $datakat = mysqli_query($koneksi, "SELECT * FROM penerima INNER JOIN pembayaran ON penerima.id_pembayaran = pembayaran.id_byr WHERE pembayaran.jenis NOT LIKE 'Donasi'");
