        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Multi Columns Form -->
                    <form class="row g-3" id="discussionForm" method="post" action="proses/input/simpanberas.php" enctype="multipart/form-data">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control" id="nil" name="nil">
                        </div>
                        ...
                        <table class="table table-borderless datatable">
                            ...
                            <tbody>
                                ...
                                include "../koneksi.php";
                                $no = 1;
                                $datakat = mysqli_query($koneksi, "select * from nilai where jenis not like 'emas'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $dk['besaran']; ?></td>
                                        <td>
                                            <a href="editfitrah.php?id_zakat=<?php echo $dk['id_zakat']; ?>" type="button"> <i class="btn btn-info bi bi-exclamation-octagon deletebtn"></i>
                                            </a>
                                        </td>
                                    </tr>
                                <?php
