...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="penerimadonasi.php">Penerima Donasi</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Form Penerima Donasi</h5>
                    ...
                    <form class="row g-3" id="discussionForm" method="post" action="proses/input/simpanpenerima.php" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            $result = mysqli_query($koneksi, "SELECT * FROM pembayaran INNER JOIN user ON pembayaran.id_byr = user.id_user WHERE pembayaran.id_zakat='7'");
