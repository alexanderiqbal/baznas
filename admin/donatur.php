    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="listdonasi.php">List Donatur</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <center>
                        <h5 class="card-title">List Donatur</h5>
                    </center>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="cetakdonatur.php" enctype="multipart/form-data">
                    ...
                    <a type="button" href="inputdonasi.php" class="btn btn-success">Tambah Data</a>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            include "../koneksi.php";
                            $no = 1;
                            $datakat = mysqli_query($koneksi, "SELECT * FROM pembayaran INNER JOIN user ON pembayaran.id_byr = user.id_user WHERE jenis LIKE 'donasi' ORDER BY tgl");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            <a href="proses/edit/prosesverifikasidonasi.php?id=<?php echo $dk['id_byr']; ?>" class="btn btn-danger"><?php echo $dk['status_byr']; ?></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php
