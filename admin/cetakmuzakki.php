        ...
        <table class="table table-borderless">
            ...
            if (isset($_POST['simpan'])) {
                ...
                if ($tglawal && $tglakhir != null) {
                    $data = mysqli_query($koneksi, "SELECT * FROM pembayaran INNER JOIN user ON pembayaran.id_bayar=user.id_user WHERE tgl BETWEEN '" . $tglawal . "' AND '" . $tglakhir . "' AND pembayaran.jenis NOT LIKE 'Donasi'");
                } else {
                    $data = mysqli_query($koneksi, "SELECT * FROM pembayaran INNER JOIN user ON pembayaran.id_bayar=user.id_user WHERE pembayaran.jenis NOT LIKE 'Donasi'");
                }
                $total += $data['jmlh'];
            }
            $no = 1;
            ...
            ?>
                ...
                <tfoot>
                    <tr>
                        <td colspan="4" scope="row">Total</td>
